    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/Prkhr01/SPM_Lab.git'
            }
        }
        ...
        stage('Deploy to Tomcat') {
            steps {
                ...
                deploy adapters: [tomcat8(credentialsId: 'tomcat', path: '', url: 'http://192.168.79.130:8081/')], contextPath: null, war: '**/*.war'
            }
        }
    }
